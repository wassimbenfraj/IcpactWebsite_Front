 ...
 */
!function (u) {
    var m = "day", a = "hour", s = "minute", d = "second", n = {d: m, h: a, m: s, s: d}, l = {
        ...
        init: function (e) {
            ...
            for (var e = u(this), t = e.data("syotimer-options"), i = y.getTimerItem(), n = u("<div/>", {class: "syotimer__head"}).html(t.headTitle), o = u("<div/>", {class: "syotimer__body"}), r = u("<div/>", {class: "syotimer__footer"}).html(t.footTitle), a = {}, s = 0; s < t.itemTypes.length; s++) {
                var d = i.clone();
                d.addClass("syotimer-cell_type_" + t.itemTypes[s]), o.append(d), a[t.itemTypes[s]] = d
            }
            var l = {headBlock: n, bodyBlock: o, footBlock: r};
            e.data("syotimer-blocks", l).data("syotimer-items", a).addClass("syotimer").append(n).append(o).append(r)
        }, _perSecondHandler: function () {
            var e = u(this), t = e.data("syotimer-options");
            ...
            var t = u(this), i = t.data("syotimer-options"), n = t.data("syotimer-items"), o = i.itemTypes,
            ...
            }, 1e3); else if ("opacity" === e) {
                var o = n.data("syotimer-items")[t];
                if (o) {
                    var r = l.next(t), a = o.data("syotimer-unit-value");
                    u(".syotimer-cell__value", o).animate({opacity: .1}, 1e3, "linear", function () {
                        c._perSecondHandler.apply(i, [])
        ...
        getTimerItem: function () {
            var e = u("<div/>", {class: "syotimer-cell__value", text: "0"}),
                t = u("<div/>", {class: "syotimer-cell__unit"}), i = u("<div/>", {class: "syotimer-cell"});
            ...
            if (n = Math.floor(n), t.periodic) {
                var o, r, a = y.getPeriodUnit(t.periodUnit), s = e / (1e3 * a);
        ...
        setOption: function (e, t) {
            var i = u(this), n = i.data("syotimer-options");
